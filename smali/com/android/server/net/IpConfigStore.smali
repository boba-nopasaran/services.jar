...
.method private writeConfig(Ljava/io/DataOutputStream;ILandroid/net/IpConfiguration;)Z
    ...
    invoke-virtual {p1, v9}, Ljava/io/DataOutputStream;->writeUTF(Ljava/lang/String;)V
    :try_end_138
    .catch Ljava/lang/NullPointerException; {:try_start_bd .. :try_end_138} :catch_9d
...
.method public readIpAndProxyConfigurations(Ljava/lang/String;)Landroid/util/SparseArray;
    ...
    :try_end_1b
    .catch Ljava/io/EOFException; {:try_start_6 .. :try_end_1b} :catch_32c
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_1b} :catch_329
    .catchall {:try_start_6 .. :try_end_1b} :catchall_326
    ...
    :try_end_3e
    .catch Ljava/lang/Exception; {:try_start_3b .. :try_end_3e} :catch_320
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/net/IpConfigStore;->loge(Ljava/lang/String;)V
    :try_end_124
    .catchall {:try_start_108 .. :try_end_124} :catchall_326
    ...
    invoke-virtual {v8}, Ljava/io/DataInputStream;->close()V
    :try_end_15f
    .catch Ljava/lang/Exception; {:try_start_15c .. :try_end_15f} :catch_323
    ...
    invoke-virtual {v11, v0}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
    :try_end_268
    .catch Ljava/lang/IllegalArgumentException; {:try_start_160 .. :try_end_268} :catch_be
    .catch Ljava/io/EOFException; {:try_start_160 .. :try_end_268} :catch_dc
    .catch Ljava/io/IOException; {:try_start_160 .. :try_end_268} :catch_106
    .catchall {:try_start_160 .. :try_end_268} :catchall_158
    ...
    packed-switch v23, :pswitch_data_330
    ...
    packed-switch v23, :pswitch_data_33a
    ...
    iput-object v0, v2, Landroid/net/IpConfiguration;->proxySettings:Landroid/net/IpConfiguration$ProxySettings;
    :try_end_2ad
    .catch Ljava/io/EOFException; {:try_start_271 .. :try_end_2ad} :catch_dc
    .catch Ljava/io/IOException; {:try_start_271 .. :try_end_2ad} :catch_106
    .catchall {:try_start_271 .. :try_end_2ad} :catchall_158
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/net/IpConfigStore;->loge(Ljava/lang/String;)V
    :try_end_2d1
    .catch Ljava/lang/IllegalArgumentException; {:try_start_2af .. :try_end_2d1} :catch_be
    .catch Ljava/io/EOFException; {:try_start_2af .. :try_end_2d1} :catch_dc
    .catch Ljava/io/IOException; {:try_start_2af .. :try_end_2d1} :catch_106
    .catchall {:try_start_2af .. :try_end_2d1} :catchall_158
    ...
    :try_end_31e
    .catch Ljava/io/EOFException; {:try_start_2d3 .. :try_end_31e} :catch_dc
    .catch Ljava/io/IOException; {:try_start_2d3 .. :try_end_31e} :catch_106
    .catchall {:try_start_2d3 .. :try_end_31e} :catchall_158
