...
.method protected chooseUpstreamType(Z)V
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/connectivity/Tethering;->access$6200(Lcom/android/server/connectivity/Tethering;)Ljava/util/Collection;
    ...
    monitor-exit v22
    :try_end_91
    .catchall {:try_start_24 .. :try_end_91} :catchall_8f
    ...
    monitor-exit v22
    :try_end_db
    .catchall {:try_start_92 .. :try_end_db} :catchall_8f
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/server/connectivity/Tethering;->access$6400(Lcom/android/server/connectivity/Tethering;)Z
    ...
    invoke-static/range {v23 .. v23}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6600(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->mPreviousDhcpv6PDIface:Ljava/lang/String;
    invoke-static/range {v21 .. v21}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6600(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/lang/String;
    ...
    invoke-static {v0, v11}, Lcom/android/server/connectivity/Tethering;->access$6500(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;)Z
    ...
    :try_end_545
    .catch Ljava/lang/Exception; {:try_start_4c8 .. :try_end_545} :catch_547
    ...
    invoke-static/range {v21 .. v22}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6900(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
...
.method protected runDhcpv6PDSequence(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6602(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Ljava/lang/String;)Ljava/lang/String;
...
.method protected turnOffMasterTetherSettings()Z
    ...
    :try_end_30
    .catch Ljava/lang/Exception; {:try_start_c .. :try_end_30} :catch_65
    ...
    # invokes: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$6100(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
    ...
    invoke-interface {v2, v3}, Landroid/os/INetworkManagementService;->setIpForwardingEnabled(Z)V
    :try_end_7e
    .catch Ljava/lang/Exception; {:try_start_72 .. :try_end_7e} :catch_65
...
.method protected turnOnMasterTetherSettings()Z
    ...
    :try_end_17
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_17} :catch_9b
    ...
    invoke-static {v6, v7}, Lcom/android/server/connectivity/Tethering;->access$5202(Lcom/android/server/connectivity/Tethering;[Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering;->access$5200(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;
    ...
    .line 2283
    :cond_4c
    const-string v6, "persist.softap.iprange"
    ...
    .line 2284
    .local v3, "rangeProp":Ljava/lang/String;
    ...
    # setter for: Lcom/android/server/connectivity/Tethering;->mDhcpRange:[Ljava/lang/String;
    invoke-static {v6, v2}, Lcom/android/server/connectivity/Tethering;->access$5202(Lcom/android/server/connectivity/Tethering;[Ljava/lang/String;)[Ljava/lang/String;

    .line 2291
    .end local v2    # "items":[Ljava/lang/String;
    .end local v3    # "rangeProp":Ljava/lang/String;
    :cond_6c
    :goto_6c
    iget-object v6, p0, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->this$1:Lcom/android/server/connectivity/Tethering$TetherMasterSM;
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->mNMService:Landroid/os/INetworkManagementService;
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering;->access$3000(Lcom/android/server/connectivity/Tethering;)Landroid/os/INetworkManagementService;
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->mDhcpRange:[Ljava/lang/String;
    invoke-static {v7}, Lcom/android/server/connectivity/Tethering;->access$5200(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;

    move-result-object v7

    invoke-interface {v6, v7}, Landroid/os/INetworkManagementService;->startTethering([Ljava/lang/String;)V
    :try_end_7f
    .catch Ljava/lang/Exception; {:try_start_1a .. :try_end_7f} :catch_b5
    ...
    :cond_80
    :try_start_80
    const-string v6, "Ipv6TetherMaster"
    ...
    invoke-interface {v6, v7}, Landroid/os/INetworkManagementService;->setIpv6ForwardingEnabled(Z)V
    :try_end_9a
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5000(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/internal/util/State;

    move-result-object v6

    # invokes: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v4, v6}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5100(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
    ...
    .line 2289
    .end local v0    # "e":Ljava/lang/Exception;
    .restart local v3    # "rangeProp":Ljava/lang/String;
    :cond_a9
    :try_start_a9
    iget-object v6, p0, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->this$1:Lcom/android/server/connectivity/Tethering$TetherMasterSM;
    ...
    invoke-static {}, Lcom/android/server/connectivity/Tethering;->access$5300()[Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5400(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/internal/util/State;

    move-result-object v6

    # invokes: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v4, v6}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5500(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
