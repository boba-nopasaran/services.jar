...
.method private getSettingsComponentName(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;
    ...
    :try_end_23
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_12 .. :try_end_23} :catch_89
    .catch Ljava/io/IOException; {:try_start_12 .. :try_end_23} :catch_91
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_12 .. :try_end_23} :catch_99
    .catchall {:try_start_12 .. :try_end_23} :catchall_a1
    ...
    invoke-static {v10, v11}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_51
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_29 .. :try_end_51} :catch_89
    .catch Ljava/io/IOException; {:try_start_29 .. :try_end_51} :catch_91
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_29 .. :try_end_51} :catch_99
    .catchall {:try_start_29 .. :try_end_51} :catchall_a1
    ...
    :try_end_65
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_57 .. :try_end_65} :catch_89
    .catch Ljava/io/IOException; {:try_start_57 .. :try_end_65} :catch_91
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_57 .. :try_end_65} :catch_99
    .catchall {:try_start_57 .. :try_end_65} :catchall_a1
...
.method private refreshDeviceLockedForUser(I)V
    ...
    if-ne v10, v3, :cond_89

    .line 326
    :try_start_85
    invoke-interface {v9}, Landroid/view/IWindowManager;->isKeyguardLocked()Z
    :try_end_88
    .catch Landroid/os/RemoteException; {:try_start_85 .. :try_end_88} :catch_ad
    ...
    monitor-exit v11
    :try_end_a0
    .catchall {:try_start_93 .. :try_end_a0} :catchall_aa
