...
.method public onDisplayConnected(Landroid/view/Surface;IIII)V
    ...
    .line 4816
    iget-object v1, p0, Lcom/android/server/display/WifiDisplayController$66;->this$0:Lcom/android/server/display/WifiDisplayController;

    iget-object v2, p0, Lcom/android/server/display/WifiDisplayController$66;->this$0:Lcom/android/server/display/WifiDisplayController;

    # getter for: Lcom/android/server/display/WifiDisplayController;->mBuildConnectDialog:Landroid/app/AlertDialog;
    invoke-static {v2}, Lcom/android/server/display/WifiDisplayController;->access$13100(Lcom/android/server/display/WifiDisplayController;)Landroid/app/AlertDialog;

    move-result-object v2

    # invokes: Lcom/android/server/display/WifiDisplayController;->dismissDialogDetail(Landroid/app/AlertDialog;)V
    invoke-static {v1, v2}, Lcom/android/server/display/WifiDisplayController;->access$13200(Lcom/android/server/display/WifiDisplayController;Landroid/app/AlertDialog;)V
    ...
    invoke-static {v1, v2}, Lcom/android/server/display/WifiDisplayController;->access$12400(Lcom/android/server/display/WifiDisplayController;Lcom/android/server/display/WifiDisplayController$SinkState;)V
    ...
    invoke-static {v2}, Lcom/android/server/display/WifiDisplayController;->access$13300(Lcom/android/server/display/WifiDisplayController;)Ljava/lang/Runnable;
    ...
    invoke-static {v1}, Lcom/android/server/display/WifiDisplayController;->access$12100(Lcom/android/server/display/WifiDisplayController;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/server/display/WifiDisplayController;->access$6900(Lcom/android/server/display/WifiDisplayController;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/display/WifiDisplayController;->access$13400(Lcom/android/server/display/WifiDisplayController;)V
    ...
    iget-object v5, p0, Lcom/android/server/display/WifiDisplayController$66;->this$0:Lcom/android/server/display/WifiDisplayController;
    ...
    invoke-static {v1, v4}, Lcom/android/server/display/WifiDisplayController;->access$13500(Lcom/android/server/display/WifiDisplayController;Z)V
...
.method public onDisplayDisconnected()V
    ...
    invoke-static {v2}, Lcom/android/server/display/WifiDisplayController;->access$11900(Lcom/android/server/display/WifiDisplayController;)Lcom/android/server/display/WifiDisplayController$SinkState;
    ...
    # getter for: Lcom/android/server/display/WifiDisplayController;->mBuildConnectDialog:Landroid/app/AlertDialog;
    invoke-static {v1}, Lcom/android/server/display/WifiDisplayController;->access$13100(Lcom/android/server/display/WifiDisplayController;)Landroid/app/AlertDialog;

    move-result-object v1

    # invokes: Lcom/android/server/display/WifiDisplayController;->dismissDialogDetail(Landroid/app/AlertDialog;)V
    invoke-static {v0, v1}, Lcom/android/server/display/WifiDisplayController;->access$13200(Lcom/android/server/display/WifiDisplayController;Landroid/app/AlertDialog;)V
    ...
    # getter for: Lcom/android/server/display/WifiDisplayController;->mRtspSinkTimeout:Ljava/lang/Runnable;
    invoke-static {v1}, Lcom/android/server/display/WifiDisplayController;->access$13300(Lcom/android/server/display/WifiDisplayController;)Ljava/lang/Runnable;
