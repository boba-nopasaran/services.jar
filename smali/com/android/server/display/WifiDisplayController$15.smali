...
.method public onDisplayConnected(Landroid/view/Surface;IIII)V
    ...
    # getter for: Lcom/android/server/display/WifiDisplayController;->mRemoteDisplayConnected:Z
    invoke-static {v3}, Lcom/android/server/display/WifiDisplayController;->access$2900(Lcom/android/server/display/WifiDisplayController;)Z
    ...
    invoke-static {v0, v2}, Lcom/android/server/display/WifiDisplayController;->access$2902(Lcom/android/server/display/WifiDisplayController;Z)Z
    ...
    invoke-static {v0}, Lcom/android/server/display/WifiDisplayController;->access$3100(Lcom/android/server/display/WifiDisplayController;)Z
    ...
    invoke-static {v3}, Lcom/android/server/display/WifiDisplayController;->access$3200(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pGroup;
    ...
    invoke-static {v2, v3, p5}, Lcom/android/server/display/WifiDisplayController;->access$3300(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pGroup;I)Landroid/hardware/display/WifiDisplaySessionInfo;
    ...
    invoke-static {v0, v2}, Lcom/android/server/display/WifiDisplayController;->access$3400(Lcom/android/server/display/WifiDisplayController;I)V
    ...
    invoke-static {v0, v2}, Lcom/android/server/display/WifiDisplayController;->access$3702(Lcom/android/server/display/WifiDisplayController;Z)Z
...
.method public onDisplayDisconnected()V
    ...
    # setter for: Lcom/android/server/display/WifiDisplayController;->mRTSPConnecting:Z
    invoke-static {v0, v1}, Lcom/android/server/display/WifiDisplayController;->access$3702(Lcom/android/server/display/WifiDisplayController;Z)Z
...
.method public onDisplayError(I)V
    ...
    invoke-static {v0, v3}, Lcom/android/server/display/WifiDisplayController;->access$2800(Lcom/android/server/display/WifiDisplayController;Z)V
    ...
    # setter for: Lcom/android/server/display/WifiDisplayController;->mRTSPConnecting:Z
    invoke-static {v0, v3}, Lcom/android/server/display/WifiDisplayController;->access$3702(Lcom/android/server/display/WifiDisplayController;Z)Z
...
.method public onDisplayKeyEvent(II)V
    ...
    invoke-static {v1}, Lcom/android/server/display/WifiDisplayController;->access$3900(Lcom/android/server/display/WifiDisplayController;)Lcom/android/internal/view/IInputMethodManager;
    ...
    invoke-static {v1}, Lcom/android/server/display/WifiDisplayController;->access$4000(Lcom/android/server/display/WifiDisplayController;)Landroid/os/PowerManager$WakeLock;
    ...
    :try_end_4b
    .catch Landroid/os/RemoteException; {:try_start_20 .. :try_end_4b} :catch_4c
