...
.method private updateOverlayDisplayDevicesLocked()V
    ...
    if-lt v5, v2, :cond_17f

    const/16 v2, 0x1000

    if-gt v5, v2, :cond_17f

    const/16 v2, 0x64

    if-lt v6, v2, :cond_17f

    const/16 v2, 0x1000

    if-gt v6, v2, :cond_17f

    const/16 v2, 0x78

    if-lt v7, v2, :cond_17f

    const/16 v2, 0x1e0

    if-gt v7, v2, :cond_17f
    ...
    :try_end_173
    .catch Ljava/lang/NumberFormatException; {:try_start_93 .. :try_end_173} :catch_19c
