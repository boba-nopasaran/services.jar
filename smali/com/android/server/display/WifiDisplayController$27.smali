...
.method public run()V
    ...
    invoke-static {v5}, Lcom/android/server/display/WifiDisplayController;->access$2000(Lcom/android/server/display/WifiDisplayController;)Landroid/media/RemoteDisplay;
    ...
    iget-object v7, p0, Lcom/android/server/display/WifiDisplayController$27;->this$0:Lcom/android/server/display/WifiDisplayController;

    # getter for: Lcom/android/server/display/WifiDisplayController;->mLatencyProfiling:I
    invoke-static {v7}, Lcom/android/server/display/WifiDisplayController;->access$9300(Lcom/android/server/display/WifiDisplayController;)I
    ...
    invoke-static {v5}, Lcom/android/server/display/WifiDisplayController;->access$9400(Lcom/android/server/display/WifiDisplayController;)I
    ...
    iget-object v6, p0, Lcom/android/server/display/WifiDisplayController$27;->this$0:Lcom/android/server/display/WifiDisplayController;

    # getter for: Lcom/android/server/display/WifiDisplayController;->mWifiP2pChannelId:I
    invoke-static {v6}, Lcom/android/server/display/WifiDisplayController;->access$9500(Lcom/android/server/display/WifiDisplayController;)I
    ...
    invoke-static {v6}, Lcom/android/server/display/WifiDisplayController;->access$7600(Lcom/android/server/display/WifiDisplayController;)I
    ...
    invoke-static {v6}, Lcom/android/server/display/WifiDisplayController;->access$8000(Lcom/android/server/display/WifiDisplayController;)I
    ...
    invoke-static {v6}, Lcom/android/server/display/WifiDisplayController;->access$7800(Lcom/android/server/display/WifiDisplayController;)I
    ...
    invoke-static {v5}, Lcom/android/server/display/WifiDisplayController;->access$8400(Lcom/android/server/display/WifiDisplayController;)Landroid/content/Context;
    ...
    invoke-static {v5}, Lcom/android/server/display/WifiDisplayController;->access$2700(Lcom/android/server/display/WifiDisplayController;)Landroid/os/Handler;
    ...
    invoke-static {v6}, Lcom/android/server/display/WifiDisplayController;->access$9600(Lcom/android/server/display/WifiDisplayController;)Ljava/lang/Runnable;
    ...
    # getter for: Lcom/android/server/display/WifiDisplayController;->mWifiScore:I
    invoke-static {v7}, Lcom/android/server/display/WifiDisplayController;->access$7600(Lcom/android/server/display/WifiDisplayController;)I
    ...
    # getter for: Lcom/android/server/display/WifiDisplayController;->mWifiRate:I
    invoke-static {v7}, Lcom/android/server/display/WifiDisplayController;->access$8000(Lcom/android/server/display/WifiDisplayController;)I
    ...
    # getter for: Lcom/android/server/display/WifiDisplayController;->mRSSI:I
    invoke-static {v7}, Lcom/android/server/display/WifiDisplayController;->access$7800(Lcom/android/server/display/WifiDisplayController;)I
