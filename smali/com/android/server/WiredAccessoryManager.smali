...
.field private static final NAME_CAMERA:Ljava/lang/String; = "camera"

.field private static final NAME_CARBACK:Ljava/lang/String; = "back-car"
...
.field private static final NAME_SOS_SWITCH:Ljava/lang/String; = "sos-switch"
...
.method static synthetic access$1100(Lcom/android/server/WiredAccessoryManager;)I
    .registers 2
    .param p0, "x0"    # Lcom/android/server/WiredAccessoryManager;
...
.method private setDeviceStateLocked(IIILjava/lang/String;)V
    ...
    :try_end_40
    .catch Ljava/lang/InterruptedException; {:try_start_3d .. :try_end_40} :catch_a5
...
.method private updateLocked(Ljava/lang/String;I)V
    ...
    const-string v10, "Got camera state:"
    ...
    const-string v8, "com.car.camera_state"
    ...
    invoke-static {v3, v8, v9}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
    ...
    const-string v10, "Got car back state:"
    ...
    const-string v8, "com.car.carback_state"
    ...
    const-string v10, "Got sos switch state:"
    ...
    const-string v8, "com.car.sos_switch_state"
    ...
    invoke-virtual {v8, v9, v2, v10, p1}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
